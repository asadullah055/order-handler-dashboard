...
const MultiLevelDropdown = () => {
  ...
  // Update Redux store based on category
  const updateReduxStore = (category, newSelection) => {
    if (category === "Order Status") dispatch(setOrderStatus(newSelection));
    if (category === "Claim") dispatch(setClaim(newSelection));
    if (category === "Settled") dispatch(setSettled(newSelection));
  };
  ...
  const handleParentChange = (category) => {
    ...
    updateReduxStore(category, updatedSelections[category]);
  };
  ...
  const handleChildChange = (category, option) => {
    ...
    updateReduxStore(category, newSelection);
  };
  // Remove individual or all filters for a category
  ...
  // Determine if a parent checkbox is indeterminate
